...
const userModel = {
  ...
  async getAll(filters = {}, page = 1, limit = 10) {
    try {
      ...
      let query = 'SELECT id, name, email, phone, profile_image, is_provider, is_doctor, created_at FROM users';
      const params = [];
  ...
  async update(id, userData, language = 'ar') {
    try {
      ...
      if (userData.is_doctor !== undefined) updateData.is_doctor = userData.is_doctor;
